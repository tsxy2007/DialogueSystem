...
#include "DTGraphSchema.generated.h"


USTRUCT()
struct DIALOGUESYSTEMEDITOR_API FSTSchemaAction_NewNode : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY();
public:
	UPROPERTY()
		UDTGraphNode* NodeTemplate;
...
USTRUCT()
struct DIALOGUESYSTEMEDITOR_API FSTSchemaAction_NewSubNode : public FEdGraphSchemaAction
{
	GENERATED_USTRUCT_BODY();
public:
	UPROPERTY()
 ...
 */
UCLASS()
class DIALOGUESYSTEMEDITOR_API UDTGraphSchema : public UEdGraphSchema
{
...
public:
	...
	virtual void GetSubNodeClasses(int32 SubNodeFlags, TArray<FDialogueGraphNodeClassData>& ClassData, UClass*& GraphNodeClass) const;
protected:
