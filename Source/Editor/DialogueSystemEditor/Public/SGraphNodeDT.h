...
class FDragDTGraphNode : public FDragNode
{
public:
	DRAG_DROP_OPERATOR_TYPE(FDragDTGraphNode, FDragNode)

	static TSharedRef<FDragDTGraphNode> New(const TSharedRef<SGraphPanel>& InGraphPanel, const TSharedRef<SGraphNode>& InDraggedNode);
	static TSharedRef<FDragDTGraphNode> New(const TSharedRef<SGraphPanel>& InGraphPanel, const TArray<TSharedRef<SGraphNode>>& InDraggedNode);

	UDTGraphNode* GetDropTargetNode()const;
 ...
 * 
 */
class DIALOGUESYSTEMEDITOR_API SGraphNodeDT : public SGraphNode
{
public:
	SLATE_BEGIN_ARGS(SGraphNodeDT){}
	SLATE_END_ARGS()

	/** Constructs this widget with InArgs */
	void Construct(const FArguments& InArgs,UDTGraphNode* InNode);
...
class DIALOGUESYSTEMEDITOR_API SGraphPinDT : public SGraphPin
{
public:
	SLATE_BEGIN_ARGS(SGraphPinDT){}
	SLATE_END_ARGS()
